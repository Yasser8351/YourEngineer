...
class AppLocalization implements Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        "ar": {
          ...
          AppConfig.tabScreen: "",
          AppConfig.addedProjetSuccesfuly: "تم اضافة المشروع بنجاح",
          AppConfig.addProjectScreen: "اضافة مشروع",
          AppConfig.add: "اضافة",
          AppConfig.attachFile: "ارفق ملف",
          ...
          AppConfig.projectName: "اسم المشروع",
          AppConfig.projectDescription: "وصف المشروع",
          AppConfig.selectCategory: "حدد القسم",
          AppConfig.selectSubCategory: "حدد القسم الفرعي",
          ...
          AppConfig.addShortDescription: "اضف وصف مختصر",
          ...
          AppConfig.noNet: "لايووجد اتصال انترنت",
          ...
          AppConfig.offerCount: "عدد العروض",
          AppConfig.dateOfPublication: "تاريخ النشر",
          AppConfig.complaint: "تقديم شكوي او مقترح",
          AppConfig.allOffer: "كل العروض",
          AppConfig.noReviewsFound: "لا توجد تقييمات",
          ...
          AppConfig.projectState: "حالة المشروع",
          ...
          AppConfig.offer: "عرض",
          AppConfig.recharge: "شحن",
          AppConfig.withdrawal: "سحب",
          AppConfig.noOfferYet: "لاتوجد عروض بعد",
          AppConfig.addReview: "قيم المهندس",
          AppConfig.yourBalance: "رصيدك",
          ...
          AppConfig.addSkills: "اضافة مهاراتك (اختياري)",
          AppConfig.priceRange: "الميزانية",
          AppConfig.addBudgets: "ميزانية المشروع",
          AppConfig.yourBudget: "كم هي ميزانية المشروع؟",
          AppConfig.projectBudget: "ميزانية المشروع",
          ...
          AppConfig.receivingProject: "استلام المشروع",
          AppConfig.open: "مفتوح",
          AppConfig.inProgress: "قيد التنفيذ",
          AppConfig.completed: "تم التسليم",
          AppConfig.close: "مغلق",
          AppConfig.specialization: "التخصص",
          AppConfig.acceptOffer: "قبول العرض",
          AppConfig.here: "هنا",
          // ignore: equal_keys_in_map
          AppConfig.chatEng: "محادثة",
          AppConfig.messages: "الرسائل",
          AppConfig.offerDetails: "تفاصيل العرض",
        ...
        "en": {
          ...
          AppConfig.yourBalance: AppConfig.yourBalance,
          ...
          AppConfig.projectDescription: AppConfig.projectDescription,
          AppConfig.offerDetails: AppConfig.offerDetails,
          AppConfig.addAmount: AppConfig.addAmount,
          AppConfig.aboutme: "About me",
          AppConfig.addBudgets: AppConfig.addBudgets,
          AppConfig.yourBudget: AppConfig.yourBudget,
          AppConfig.selectCategory: AppConfig.selectCategory,
          AppConfig.selectSubCategory: AppConfig.selectSubCategory,
          AppConfig.amount: AppConfig.amount,
          AppConfig.transferReceipt: AppConfig.transferReceipt,
          AppConfig.skills: "Skills",
          AppConfig.messages: AppConfig.messages,
          ...
          AppConfig.noOfferYet: AppConfig.noOfferYet,
          ...
          AppConfig.recharge: AppConfig.recharge,
          AppConfig.withdrawal: AppConfig.withdrawal,
          AppConfig.days: AppConfig.days,
          AppConfig.day: AppConfig.day,
          ...
          AppConfig.projectName: AppConfig.projectName,
          AppConfig.lastName: AppConfig.lastName,
          AppConfig.addShortDescription: AppConfig.addShortDescription,
          ...
          AppConfig.receivingProject: AppConfig.receivingProject,
          AppConfig.tryAgain: AppConfig.tryAgain,
          AppConfig.login: AppConfig.login,
          AppConfig.projectBudget: AppConfig.projectBudget,
          AppConfig.dateOfPublication: AppConfig.dateOfPublication,
          ...
          AppConfig.offerCount: AppConfig.offerCount,
          ...
          AppConfig.projectState: AppConfig.projectState,
          ...
          AppConfig.open: "Open",
          AppConfig.inProgress: "In Progress",
          AppConfig.completed: "Completed",
          AppConfig.close: "Closed",
